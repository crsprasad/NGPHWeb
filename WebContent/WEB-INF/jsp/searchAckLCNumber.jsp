...
<script type="text/javascript">
	...
	{	
		window.opener.document.getElementById("relatedReference").value = lcNumber;
		alert("Hi");
		window.close();
	}
	function cancel() {
...
<s:actionerror />
<s:form method="post" action="getLCNumber" >
		...
		<table width="100%" cellpadding="3" cellspacing="1" border="0"
			...
			<tr>
				<td width="25%" class="textRight"><s:label
					value="Receiver Bank's Reference"></s:label>:&nbsp;</td>
				<td width="25%" class="text"><s:textfield name="lcNumberFetch" id="lcNumberFetch"></s:textfield></td>
		...
		<table width="100%" cellpadding="0" cellspacing="0" border="0"
			...
			<tr>
				...
				<div style="overflow: auto; height: 245px; width: 100%;border:0px solid #ff0000;">
					<display:table id="row"  name="searchList" requestURI="/getLCNumber" cellpadding="5" cellspacing="1" class="dataGrid" pagesize="5">
