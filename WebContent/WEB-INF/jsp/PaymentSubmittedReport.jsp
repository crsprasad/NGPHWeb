...
<div id="contentPaneInternal"><span class="crumbs"><a
	href="#">Enquiries & Reports</a>&nbsp;>&nbsp;Payment Sent Report</span></div>
<div id="content">
<h1>Payment Sent Report</h1>

<s:form name="report" action="PaymentSubmittedReportLoadData"
	...
	<table width="100%" cellpadding="3" cellspacing="1" border="0"	bgcolor="#ffffff">
		...
		<tr>
					...
					<td class="text"><s:radio
						...
						value="N/A" name="SenderReceiver" required="true" value="%{SenderReceiver}" ></s:radio></td>
				</tr>
				<tr>
					<td class="text">
	...
	<div><!-- Group Two Div Starts --> <s:div id="mandatory"
		...
		<tr>
			...
			bgcolor="#ffffff"><tr>
					<td class="textRight"><s:label key="label.receiver"
						name="Receiver"></s:label>:&nbsp;</td>
					...
					<td class="text"><s:textfield name="orderingCustomer"
						id="orderingCustomer" cssClass="text"></s:textfield></td>
				</tr>
				<tr>
					<td class="textRight"><s:label value="From Date"></s:label></td>
					<td class="text"><sd:datetimepicker name="ValueFromDate" value="today" id="ValueFromDate" displayFormat="MM/dd/yy"></sd:datetimepicker></td>
					<td class="textRight"><s:label name="ValueToDateLabel" value= "To Date"></s:label></td>
					<td class="text"><sd:datetimepicker name="ValueToDate" displayFormat="MM/dd/yy" value="today" id="ValueToDate" cssClass="text" /></td>
				</tr>
			
				<tr>
				
					<td class="textRight"><s:label name="From_Amount"
						value="From Amount"></s:label></td>
					<td class="text"><s:textfield name="fromAmount"
						id="fromAmount" cssClass="text"></s:textfield></td>
					<td class="textRight"><s:label name="ToAmount"
						value="To Amount"></s:label></td>
					<td class="text"><s:textfield name="toAmount" id="toAmount"
						cssClass="text"></s:textfield></td>
				</tr>
				<tr>
		
					<td class="textRight"><s:label key="label.HostName" name="hostName" id="hostName" ></s:label></td>
					<td class="text">
					<s:select
					...
					<td class="text"><s:select
						...
						id="MessageList" size="8" multiple="true" cssClass="text" size="5" style="width: 50mm" ></s:select></td>
				</tr>
			</table></td>
			<td>
			...
			bgcolor="#ffffff">
				<tr>
					...
					<br /><input type="button"
						class="btn" value=">>"
						onClick="if (document.images) copySelected(this.form.select1,this.form.coloumToAdd)">
					<br />
					<br />
	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0">
		<tr>
			<td><s:submit value="Generate Report" cssClass="btn"
				action="generateReport"></s:submit></td>
		</tr>
	</table>
	<!--  button panel ends -->
	<s:hidden name="hiddenDirection" value="O"></s:hidden>
</s:form></div>
</div>
</div>
