...
function assignPopup(txnRef,actionScreen) {
...
<div id="contentPaneInternal"><span class="crumbs"><a
	href="#">System </a>&nbsp;>&nbsp;Pending Authorisation</span></div>
<div id="content">
<s:form method="post" id="form"></br></br></br>
<s:hidden name="txnRef" id="txnRef"></s:hidden>
<display:table uid="row" name="screenValue" pagesize="10" requestURI="/genericScreenFetchValues" cellpadding="3"
				...
				<display etProperty name="css.tr.odd" value="TDBGgray" cssClass="odd"/>
					...
					<display:column title="TXN Ref" headerClass="gridHdrBg"  style="text-align:center">
	    				...
	    				<a href="javascript:assignPopup('${row.screenID}','${row.screenData}')">
