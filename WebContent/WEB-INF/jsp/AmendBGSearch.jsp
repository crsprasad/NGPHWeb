...
<script type="text/javascript">
	function assignPopup(bgNumber) {			
			window.opener.document.getElementById("relatedReference").value = bgNumber;
		window.close();
	...
	{		
		var parentAction = window.opener.document
				.getElementById("getAmendBGData").value;
...
<s:actionerror />
<s:form method="post" action="getAmendBGData" name="searchForm">
		...
		<table width="100%" cellpadding="3" cellspacing="1" border="0"
			...
			<tr>
				<td width="25%" class="textRight"><s:label
					value="BG Number"></s:label>:&nbsp;</td>
				<td width="25%" class="text"><s:textfield name="bgNumber" id="bgNumber"></s:textfield></td>
		...
		<table width="100%" cellpadding="0" cellspacing="0" border="0"
			...
			<tr>
				...
				<div style="overflow: auto; height: 245px; width: 100%;border:0px solid #ff0000;">
					<display:table id="row" name="searchList" requestURI="/getAmendBGData" cellpadding="5" cellspacing="1" class="dataGrid" pagesize="10">
    				...
    				<a href="javascript:assignPopup('${row.bgNumber}')">${row.bgNumber}
		 			</a>
					</display:column>
