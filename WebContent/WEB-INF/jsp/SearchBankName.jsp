...
<script type="text/javascript">
	function assignPopup(bankName) {
		window.opener.document.getElementById("bankName").value = bankName;
		window.close();
...
<body>
<s:form method="post" action="getBankNameList" >
	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0"
		...
		<table width="100%" cellpadding="3" cellspacing="1" border="0"
			...
			<tr>
				<td width="25%" class="textRight"><s:label value="Bank Name"></s:label>:&nbsp;</td>
				<td width="25%" class="text"><s:textfield name="bankName" id="bankName"></s:textfield></td>
		...
		<table width="100%" cellpadding="0" cellspacing="0" border="0"
			...
			<tr>
				...
				<div style="overflow: auto; height: 245px; width: 100%;border:0px solid #ff0000;">
					<display:table uid="row" name="sessionScope.bankNameList" pagesize="10" requestURI="/getBankNameList" cellpadding="3"
				...
				<display:column title="Bank Name" headerClass="gridHdrBg" class="gridText" style="text-align:center">
					<display:setProperty name="basic.msg.empty_list" 
    				value='<div class="searchMsg" ><span>Nothing found to display</span></div>' />
    				<a href="javascript:assignPopup('${row.partyBankName}')">${row.partyBankName}
		 			</a>
				</display:column>
