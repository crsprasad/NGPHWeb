...
<div id="contentPaneInternal"><span class="crumbs"><a
	href="#">Enquiries & Reports</a>&nbsp;>&nbsp;Lc Received Reports</span></div>
<div id="content">
<h1>Lc Received Reports</h1>
<s:form method="post">
	...
	<div class="CollapsiblePanelTab"><!--  <img src="images/openPanel.png" width="9" height="7" alt="openPanel" />-->&nbsp;Colums To display</div>
	<div class="CollapsiblePanelContent">
		...
		<table width="100%" cellpadding="3" cellspacing="1" border="0"
				...
				<tr>
					...
					<select multiple="multiple"	size="8" name="selectColumn" id="selectColumn" class="text" style="width: 50mm">
						...
						<option value="lcAdvisingBank">Issuing Bank</option>
