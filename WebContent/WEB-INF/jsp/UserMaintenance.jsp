...
<div id="content">
	...
	<div>
		...
		<div><s:if test="hasActionMessages()">
			<div class="actionMsg"><span class="errorMsgInline"><s:actionmessage /></span></div>
</s:if></div>
	</div>
	<!--Error Msg Div Ends -->
				...
				<div>
					...
					<s:div id="main" cssClass="dataGrid" style="width:100%;"> 
						<table width="100%" cellpadding="3" cellspacing="1" border="0" bgcolor="#ffffff">
							...
							<tr>
								<td class="textRight">
									<s:label value="Security Question"></s:label>:<span class="mandatory">*</span>
								</td>
								<td class="text">
								...
								<td class="text">&nbsp;</td>
								<td class="textRight">
									<s:label value="Security Answer"></s:label>:<span class="mandatory">*</span>
								</td>
								<td class="text">
									<s:textfield name="securityAnswer" cssClass="text" id="securityAnswer" required="true"></s:textfield>
								</td>
								<td class="text">&nbsp;</td>
							</tr>
							<tr>
							...
							<s:if test="%{checkForSubmit!='Display_Approve_Reject'}">
								...
								<td class="text">
									<s:password name="userPassword" id="userPassword" required="true"></s:password>
								</td>
								<td class="text">&nbsp;</td>
							</s:if>
							</tr>
