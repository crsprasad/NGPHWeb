...
<script type="text/javascript">
	function assignPopup(authorisedBankCode) {
			alert("hello")
			window.opener.document.getElementById("advisingBank").value = authorisedBankCode;
		...
		<table width="100%" cellpadding="3" cellspacing="1" border="0"
			...
			<tr>
				<td width="25%" class="textRight">
					<s:label value="IFSC Code"> </s:label>:&nbsp;
				</td>
				<td width="25%" class="text">
					<s:textfield name="ifscCode" id="ifscCode"></s:textfield>
				</td>
		...
		<table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" align="center">
			...
			<tr>
				...
				<div style="overflow: auto; height: 245px; width: 100%;border:0px solid #ff0000;">
					<display:table id="row" name="ifscList"  cellpadding="5" cellspacing="1" class="dataGrid" pagesize="8" requestURI="/searchIFSCCode">
					<display:column title="IFSC CODE" headerClass="gridHdrBg" class="gridText">
						<display:setProperty name="basic.msg.empty_list" value='<div class="searchMsg"><span>Nothing found to display</span></div>' />
	    				<a onclick="javascript:assignPopup('${row.clearingSystemMemberId}')" href="#">${row.clearingSystemMemberId}</a>
			 			</display:column>
