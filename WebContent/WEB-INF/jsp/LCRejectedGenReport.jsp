...
<div id="contentPaneInternal"><span class="crumbs"><a
	href="#">Enquiries & Reports</a>&nbsp;>&nbsp;Lc Rejected Report</span></div>
<div id="content">
<h1><s:label name="title" ></s:label></h1>
<s:form method="post" action="downloadReportLcRejectReport" validate="true" id="form">
...
<div><s:label name="message"></s:label><s:if test="hasFieldErrors()">
	...
	<table width="100%" cellpadding="3" cellspacing="1" border="0">
		<tr>
			...
			<display:table id="data" uid="row" name="sessionScope.displayList" pagesize="10"  requestURI="/generteLcRejectReports" cellpadding="3"
				...
				<display:column title="Issue Date" property="lcIssueDate" headerClass="gridHdrBg"  sortable="false" style="text-align:center"/></s:if>
				...
				<display:column title="Expiry Date" property="lcExpireDate"	headerClass="gridHdrBg"  sortable="false" style="text-align:center" />
				</s:if>
