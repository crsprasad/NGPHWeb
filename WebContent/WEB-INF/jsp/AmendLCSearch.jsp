...
<script type="text/javascript">
	...
	function DataSearch() {		
		...
		var parentAction = window.opener.document
				.getElementById("getAdmendLCData").value;
...
<s:actionerror />
<s:form method="post" action="getAdmendLCData" name="searchForm">
		...
		<table width="100%" cellpadding="0" cellspacing="0" border="0"
			...
			<tr>
				...
				<div style="overflow: auto; height: 245px; width: 100%;border:0px solid #ff0000;">
					<display:table id="row" name="searchList" requestURI="/getAdmendLCData" cellpadding="5" cellspacing="1" class="dataGrid" pagesize="10">
