...
<script type="text/javascript">
	...
	function callPrintPreView(msgType)
	{
		alert("msgType is "+document.getElementById("msgType").value);
		alert("MsgRef is "+document.getElementById("msgRef").value);
...
<s:form method="post" action="displayMessages">
	...
	<s:hidden name="msgType" id="msgType"></s:hidden>
	<table width="100%" cellpadding="0" cellspacing="0" border="0">
		...
		<tr>
			...
			--><input type="button" value="View Raw Message" onclick="openPopUp()"/> &nbsp;
			<input type="button" value="Back To Payment Enquiry" onclick="goBack()"/> &nbsp;
