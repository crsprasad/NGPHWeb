...
<script type="text/javascript">
	function assignPopup(bankName) {
		window.opener.document.getElementById("branchName").value = bankName;
		window.close();
	...
	function DataSearch() {
		...
		document.getElementById("ifscCode").value  = window.opener.document.getElementById("ifscCode").value;
...
<s:form method="post" action="getBranchNameList" >
	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0"
		...
		<table width="100%" cellpadding="3" cellspacing="1" border="0"
			...
			<tr>
				<td width="25%" class="textRight"><s:label value="Branch Name"></s:label>:&nbsp;</td>
				<td width="25%" class="text"><s:textfield name="branchName" id="branchName"></s:textfield></td>
		...
		<table width="100%" cellpadding="0" cellspacing="0" border="0"
			...
			<tr>
				...
				<div style="overflow: auto; height: 245px; width: 100%;border:0px solid #ff0000;">
					<display:table uid="row" name="sessionScope.branchNameList" pagesize="10" requestURI="/getBranchNameList" cellpadding="3"
				...
				<display:column title="Branch Name" headerClass="gridHdrBg" class="gridText" style="text-align:center">
					<display:setProperty name="basic.msg.empty_list" 
    				value='<div class="searchMsg" ><span>Nothing found to display</span></div>' />
    				<a href="javascript:assignPopup('${row.branchName}')">${row.branchName}
		 			</a>
				</display:column>
