...
<div id="contentPaneInternal"><span class="crumbs"><a
	href="#">Enquiry</a>&nbsp;>&nbsp;Bg Receive Reports</span></div>
<div id="content">
<h1>Bg Receive Reports</h1>
<s:hidden id="repairComments" name="repairComments"></s:hidden> 
<s:form method="post">
<s:hidden name="lcDirection" id="lcDirection" value="I"></s:hidden>	
<s:hidden name="advising_issuingBank" id="advising_issuingBank" value="issuingBank"></s:hidden>
	...
	<tr>
				<td  align="center"><s:radio list="{'Issuing Bank','N/A'}" name="groupBy" id="groupBy"></s:radio></td>
	...
	<div><!-- Group Two Div Starts --> <s:div id="mandatory"
		...
		<table width="100%" cellpadding="5" cellspacing="1" border="0" bgcolor="#ffffff">
			...
			<td width="20%" class="textRight"><s:label
					value="%{getText('label.IssuingBank')}"></s:label>:</td>
			...
			<select name="selectBG" id="selectBG" multiple="multiple">
			<option value="1">CREATED</option>
			<option value="2">REQUESTED</option>
			<option value="3">CREATEDACK</option>
			<option value="4">AMENDED</option>
			<option value="5">AMENDED REGISTERED</option>
			<option value="6">REDUCED</option>
			<option value="7">REDUCED ACK</option>
			<option value="8">RELEASE REQUEST</option>
		...
		<tr>
			...
			<td width="30%" class="text"><sx:datetimepicker name="fromDate" id="fromDate" value="today"></sx:datetimepicker> </td>
		...
		<table width="100%" cellpadding="3" cellspacing="1" border="0"
				...
				<tr>
					...
					<select multiple="multiple"	size="8" name="selectColumn" id="selectColumn" class="text" style="width: 50mm">
						...
						<option value="advisingBank">Issuing Bank</option>
						...
						<option value="bgAmount">Amount</option>
						<option value="bgStatus">Status</option>
						<option value="bgNoOfAmntmnt">No Of Amntmnt</option>
						<option value="bgLastModifiedTime">Last Modified Time</option>
						<option value="advisingBank">Lc Issuing Bank</option>
						<option value="details">Details</option>
					--></select></td>
	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0">
		<tr>
			<td>
				...
				<s:submit value="Generate Reports" action="generteBgReports" cssClass="btn" />
