...
<script type="text/javascript">
	...
	function DataSearch() {
		...
		var status = window.opener.document.getElementById("msgStatusForLcFetch").value;
		var msgDirection = window.opener.document.getElementById("msgDirection").value;
		document.getElementById("msgDirection").value = msgDirection; 
...
<s:actionerror />
<s:form method="post" action="populatedTransferDocumentaryContent" >
	<s:hidden id="action" name="action" />
	<s:hidden id="msgStatusForLcFetch" name="msgStatusForLcFetch"></s:hidden>
	<s:hidden id="msgDirection" name="msgDirection"></s:hidden>
