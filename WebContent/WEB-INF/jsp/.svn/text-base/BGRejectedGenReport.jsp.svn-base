...
<div id="contentPaneInternal"><span class="crumbs"><a
	href="#">Enquiries & Reports</a>&nbsp;>&nbsp;Bg Rejected Reports</span></div>
<div id="content">
<h1><s:label name="title" ></s:label></h1>
<s:form method="post" action="downloadReportBgRejectReport" validate="true" id="form">
...
<div><s:label name="message"></s:label><s:if test="hasFieldErrors()">
	...
	<table width="100%" cellpadding="3" cellspacing="1" border="0">
		<tr>
			...
			<display:table id="data" uid="row" name="sessionScope.displayBgList" pagesize="10"  requestURI="/generteBgRejectReports" cellpadding="3"
