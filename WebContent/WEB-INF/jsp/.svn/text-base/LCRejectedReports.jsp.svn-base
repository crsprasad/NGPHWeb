...
<div id="contentPaneInternal"><span class="crumbs"><a
	href="#">Enquiry</a>&nbsp;>&nbsp;Lc Rejected Reports</span></div>
<div id="content">
<h1>Lc Rejected Reports</h1>
...
<!--<s:hidden name="advising_issuingBank" id="advising_issuingBank" value="advisingBank"></s:hidden>
	...
	<div><!-- Group Two Div Starts --> <s:div id="mandatory"
		...
		<table width="100%" cellpadding="5" cellspacing="1" border="0" bgcolor="#ffffff">
			...
			list="#{'01':'PRE ADVICE','02':'PRE ADVICE ACK','03':'OPENED','04':'REGISTERED','05':'AMENDED','06':'AMEND REGISTERED','07':'PYMT ADVICED','08':'PYMT AUTHORISED','09':'CLAIMED','10':'CLAIM-PAID'}" multiple="true"></s:select> </td>
		-->
		...
		--><tr>
			<td width="20%" class="textRight"><s:label
					value="%{getText('label.fromDate')}"></s:label>:<span	class="mandatory">*</span></td>
			<td width="30%" class="text"><sx:datetimepicker name="fromDate" id="fromDate" value="today"></sx:datetimepicker> </td>
			<td width="20%" class="textRight"><s:label	value="%{getText('label.toDate')}"></s:label>:<span	class="mandatory">*</span></td>
		...
		<table width="100%" cellpadding="3" cellspacing="1" border="0"
				...
				<tr>
					...
					<select multiple="multiple"	size="8" name="selectColumn" id="selectColumn" class="text" style="width: 50mm">
						...
						<option value="lcAdvisingBank">Advising Bank(O)/Issuing Bank(I)</option>
	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0">
		<tr>
			<td>
				...
				<s:submit value="Generate Reports" action="generteLcRejectReports" cssClass="btn" />
