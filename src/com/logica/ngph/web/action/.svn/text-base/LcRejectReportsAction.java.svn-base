...
public class LcRejectReportsAction extends ActionSupport implements SessionAware {
	private Logger logger = Logger.getLogger(LcRejectReportsAction.class);
	...
	public static void setDirection(String direction) {
		LcRejectReportsAction.direction = direction;
	}
	...
	public String displayLcRejectScreen()
	{
		try{
			removeForSession();
	...
	*/
	...
	public String generateReport()
	{
		try{
			...
			String localBankIFSC = lcReportsService.getLocalBankIFSC(userId);
...
//				System.out.println(sdf.format(date1));
				...
				if(valid.equals("true")){
					...
					createQuery = "lc.lstModifiedTime between (to_date('"+sdf.format(date1)+" 00:00:00' , 'dd-MON-yy hh24:mi:ss')) AND (to_date('"+sdf.format(date2)+" 23:59:59' , 'dd-MON-yy hh24:mi:ss'))";
					System.out.println("Create Query : - "+ createQuery);
				}
				setDisplayList(lcReportsService.getLcRejectReportData(getLcDirection(),createQuery,tablename,localBankIFSC,msgBranch));
	...
	public String downloadReport(){
		...
		String reportName ="LC Rejected Report";
