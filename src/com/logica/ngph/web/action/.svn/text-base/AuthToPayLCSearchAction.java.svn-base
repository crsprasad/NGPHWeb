...
public class AuthToPayLCSearchAction {
	static Logger logger = Logger.getLogger(AuthToPayLCSearchAction.class);
	...
	public String getSearchData()
	{
		try{
			...
			setSearchList(adviceLCPaymentService.getLCAuthtoPayData(getLcNumber()));
			return "populateData";
