...
public class PaymentMessageStatusAction extends ActionSupport implements SessionAware{
	...
	private String paymentMessageSubType;
	private String msgDirction;
	
	/**
	 * @return the paymentMessageSubType
	 */
	public String getPaymentMessageSubType() {
		return paymentMessageSubType;
	}
	/**
	 * @param paymentMessageSubType the paymentMessageSubType to set
	 */
	public void setPaymentMessageSubType(String paymentMessageSubType) {
		this.paymentMessageSubType = paymentMessageSubType;
	}
	...
	*/
	...
	public String paymentToRepairLc() {
		try{
		PaymentMessageService paymentMessageService = (PaymentMessageService)ApplicationContextProvider.getBean("paymentMessageService");
		System.out.println("msgType is :: "+getPaymentMessageType());
	...
	*/
	...
	public String getPaymentMessage(){
		...
		System.out.println("Payment Status is ::"+paymentStatValDb);
